...
<div class="max-w-2xl max-h-full mx-auto">
    ...
    <div class="bg-white p-6 rounded-md shadow-md mb-4">
            ...
            <table class="w-full table-auto">
                ...
                <c:forEach items="${dtoList}" var="dto">
                    <tr>
                        ...
                        <td class="border-0 border-b-2 border-gray-300 px-4 py-2"><a href="/todo/read?tno=${dto.tno}"><c:out value="${dto.title}"/></a></td>
        ...
        <ul class="pagination flex justify-center">
            <li><a href="#" class="px-4 py-2 bg-gray-800 text-white rounded-l-md hover:bg-gray-700 hover:pointer-events-auto">Previous</a></li>
            <li><a href="#" class="px-4 py-2 bg-gray-800 text-white hover:bg-gray-700 hover:pointer-events-auto">1</a></li>
            <li><a href="#" class="px-4 py-2 bg-gray-800 text-white hover:bg-gray-700 hover:pointer-events-auto">2</a></li>
            <li><a href="#" class="px-4 py-2 bg-gray-800 text-white hover:bg-gray-700 hover:pointer-events-auto">3</a></li>
            <li><span class="px-4 py-2">...</span></li>
            <li><a href="#" class="px-4 py-2 bg-gray-800 text-white hover:bg-gray-700 hover:pointer-events-auto">10</a></li>
            <li><a href="#" class="px-4 py-2 bg-gray-800 text-white rounded-r-md hover:bg-gray-700 hover:pointer-events-auto">Next</a></li>
        </ul>
    </div>
</div>
